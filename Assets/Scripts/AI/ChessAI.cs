    ...
    public class ChessAI : MonoBehaviour
    {
        ...
        private Move DepthLimitedSearch(Board board, int depth)
        {
            ...
            foreach (var move in allMoves)
            {
                ...
                // No need to destroy - BoardState is just data, GC will handle it
        ...
        /// <summary>
        /// Legacy Minimax algorithm with alpha-beta pruning (DEPRECATED).
        /// Use MinimaxState for better performance.
        /// </summary>
        [System.Obsolete("Use MinimaxState for better performance")]
